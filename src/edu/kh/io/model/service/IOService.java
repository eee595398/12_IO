...
public class IOService {
	...
	public void output1() {
		...
		// FileNotFoundException / IOExecption 예외가 발생할 가능성이 있음 -> 예외 처리 필요
	...
	public void output2() {
		...
		try {
			...
			fw.write(str);
			// 실행 했는데 출력이 안되고 있다 
			// 한 줄을 통째로 보내기 위해서 버퍼를 이용하는데
			// 아직 버퍼에 담겨있음 이걸로 강제로 밀어넣어서 버퍼를 비워야함 
			
			//close() 구문을 수행하면 통로에 남아있는 내용을 모두 내보고 
			// 통로를 없앤다
	...
	public void input1() {
		...
		try {
			...
			// FileInputStream은 1byte씩만 읽어올수 있다.
